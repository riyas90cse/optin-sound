...
<div id="page-wrapper">       
    <div class="row">
		...
		<?php endif; ?>
      	<form method="post" action="<?php echo e(url('/class-section-stream/update/'.$cscombination[0]->id)); ?>">
      	<?php echo e(csrf_field()); ?>
			...
			<div class="form-group">
				  ...
				  <select class="form-control" name="stream" id="stream" required="">
						...
						<option value="<?php echo e($value->id); ?>" <?php if($cscombination[0]->stream==$value->id) echo 'selected';?>><?php echo e($value->name); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
				  </select>
			</div>
