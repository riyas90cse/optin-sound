					...
					<div class="row actiontype" id="manualplay_option" style="display:block;">
						...
						<div class="form-group">
							...
							<p class="setting-title">Your Name / Brand Name <span class="tooltip1" title="headline for the widget."><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="topbar_text" id="topbar_text" value="<?php echo e($campaign[0]->topbar_text); ?>" required="required" placeholder="Write Brand Name"/>					
							</div>
							...
							<p class="setting-title">Text Color<span class="tooltip1" title="Text Color for the Headline text"><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="topbar_color" id="topbar_color" value="<?php echo e($campaign[0]->topbar_color); ?>" placeholder="Text Color"/>					
							</div>
							...
							<p class="setting-title">Bg Color<span class="tooltip1" title="Background Color for the Headline text"><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="topbar_bg" id="topbar_bg" value="<?php echo e($campaign[0]->topbar_bg); ?>" placeholder="Bg color"/>					
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								...
								<img width="80px" class="play_icon" src="<?php echo e($campaign[0]->brandlogo); ?>">
								<input value="<?php echo e($campaign[0]->brandlogo); ?>" type="hidden" name="brandlogo" id="brandlogo">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<p class="setting-title">Headline Text<span class="tooltip1" title="headline for the widget."><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="headline_text" id="headline_text" value="<?php echo e($campaign[0]->headline_text); ?>" required="required" placeholder="Write Headline Text"/>					
							</div>
							<div class="col-md-3 col-xs-6 col-sm-6">
							<p class="setting-title">Text Color<span class="tooltip1" title="Text Color for the Headline text"><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="headline_color" id="headline_color" value="<?php echo e($campaign[0]->headline_color); ?>" placeholder="Text Color"/>					
							</div>
							<div class="col-md-2  col-xs-6 col-sm-6">
							<p class="setting-title">Bg Color<span class="tooltip1" title="Background Color for the Headline text"><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="headline_bg" id="headline_bg" value="<?php echo e($campaign[0]->headline_bg); ?>" placeholder="Bg color"/>					
							</div>
						</div>
						...
						<div class="form-group">
							...
							<p class="setting-title">Description Text<span class="tooltip1" title="Description for the widget."><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="description_text" id="description_text" value="<?php echo e($campaign[0]->description_text); ?>" required="required"  placeholder="Write Description Text"/>					
							</div>
							<div class="col-md-3 col-xs-6 col-sm-6">
							<p class="setting-title">Text Color<span class="tooltip1" title="Text Color for the Description text"><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="description_color" id="description_color" value="<?php echo e($campaign[0]->description_color); ?>" placeholder="Text Color"/>					
							</div>
							<div class="col-md-2  col-xs-6 col-sm-6">
							<p class="setting-title">Bg Color<span class="tooltip1" title="Background Color for the Description text"><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="description_bg" id="description_bg" value="<?php echo e($campaign[0]->description_bg); ?>" placeholder="Bg color"/>					
							</div>	
						</div>
						<div class="form-group">
							<div class="col-md-7">
							...
							<div class="col-md-5">
								...
								<img class="play_icon" src="<?php echo e($campaign[0]->playicon); ?>">
								<input value="<?php echo e($campaign[0]->playicon); ?>" type="hidden" name="play_icon" id="play_icon">
							</div>
						</div>	
					</div>
				</div>
					...
					<p class="opt-title">Optin Settings <span class="tooltip1" title="Here are some basic settings for the widget, Please fill below fields for Widget."><i class="fa fa-info-circle"></i></span></p>
						...
						<div class="form-group">
							...
							<p class="setting-title">Optin Message  <span class="tooltip1" title="headline for the widget."><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="optin_message" id="optin_message" value="<?php echo e($campaign[0]->optin_message); ?>" required="required" placeholder="Write Optin Message"/>					
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12  col-xs-12 col-sm-12">
							<p class="setting-title">Optin Message in Skip Condition<span class="tooltip1" title="headline for the optin."><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="sp_optin_message" id="sp_optin_message" value="<?php echo e($campaign[0]->sp_optin_message); ?>" required="required" placeholder="Write Optin Message for Skip Condition Here"/>					
							</div>
						</div>
						...
						<div class="form-group">
							...
							<p class="setting-title">Thank You Message <span class="tooltip1" title="Description for the widget."><i class="fa fa-info-circle"></i></span></p>
								<input class="form-control" name="thankyou_message" id="thankyou_message" value="<?php echo e($campaign[0]->thankyou_message); ?>" required="required"  placeholder="Write Thank You Message on successful submission."/>					
							</div>
						</div>
				...
				<div class="col-md-8 col-xs-8 col-sm-8 col-md-offset-2 pt5" >
					...
					<div class="form-group">
						...
						<div class="col-md-12  col-xs-12 col-sm-12 insite_trigger" <?php if(isset($insitetrigger) && $insitetrigger=='active') { echo 'style="display: block;"';} else { echo 'style="display: none;"';} ?> >
							...
							<input class="form-control" name="trigger_elements" value="<?php echo e($campaign[0]->trigger_elements); ?>" id="trigger_elements" placeholder="Add Elements"/>					
						</div>
					</div>
