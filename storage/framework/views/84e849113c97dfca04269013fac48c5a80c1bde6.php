...
var fontkits={
"Arimo":"@import  url('https://fonts.googleapis.com/css?family=Arimo');",
"Arvo":"@import  url('https://fonts.googleapis.com/css?family=Arvo');",
"Cabin":"@import  url('https://fonts.googleapis.com/css?family=Cabin');",
"Dosis":"@import  url('https://fonts.googleapis.com/css?family=Dosis');",
"Fjalla+One":"@import  url('https://fonts.googleapis.com/css?family=Fjalla+One');",
"Inconsolata":"@import  url('https://fonts.googleapis.com/css?family=Inconsolata');",
"Karla":"@import  url('https://fonts.googleapis.com/css?family=Karla');",
"Lato":"@import  url('https://fonts.googleapis.com/css?family=Lato');",
"Libre+Franklin":"@import  url('https://fonts.googleapis.com/css?family=Libre+Franklin');",
"Montserrat":"@import  url('https://fonts.googleapis.com/css?family=Montserrat');",
"Muli":"@import  url('https://fonts.googleapis.com/css?family=Muli');",
"Nanum+Gothic":"@import  url('https://fonts.googleapis.com/css?family=Nanum+Gothic');",
"Nunito":"@import  url('https://fonts.googleapis.com/css?family=Nunito');",
"Open+Sans":"@import  url('https://fonts.googleapis.com/css?family=Open+Sans');",
"Oswald":"@import  url('https://fonts.googleapis.com/css?family=Oswald');",
"Oxygen":"@import  url('https://fonts.googleapis.com/css?family=Oxygen');",
"PT+Sans":"@import  url('https://fonts.googleapis.com/css?family=PT+Sans');",
"PT+Serif":"@import  url('https://fonts.googleapis.com/css?family=PT+Serif');",
"Quicksand":"@import  url('https://fonts.googleapis.com/css?family=PT+Quicksand');",
"Raleway":"@import  url('https://fonts.googleapis.com/css?family=Raleway');",
"Roboto":"@import  url('https://fonts.googleapis.com/css?family=Roboto');",
"Roboto+Condensed":"@import  url('https://fonts.googleapis.com/css?family=Roboto+Condensed');",
"Roboto+Slab":"@import  url('https://fonts.googleapis.com/css?family=Roboto+Slab');",
"Rubik":"@import  url('https://fonts.googleapis.com/css?family=Rubik');",
"Sunflower:300":"@import  url('https://fonts.googleapis.com/css?family=Sunflower:300');",
"Ubuntu":"@import  url('https://fonts.googleapis.com/css?family=Ubuntu');",
"Work+Sans":"@import  url('https://fonts.googleapis.com/css?family=Work+Sans');"
}


//  Font family preview:     "font-family: 'Roboto', sans-serif;";
...
<div class="contentpanel campaign-page">
	<div id="page-wrapper">
		...
		<div class="campsection step2" id="step2">
			<div class="content">
				<form method="get" id="widget_action1" action="<?php echo e(url('campaign/savewidget')); ?>">
				<div class="row">
					<div class="col-md-12">
				...
				<div class="row" id="action_section">
						...
						<p class="opt-title">Widget Settings <span class="tooltip1" title="Here are some basic settings for the widget, Please fill below fields for Widget."><i class="fa fa-info-circle"></i></span></p>
							...
							<div class="form-group">
								...
								<p class="setting-title">Your Name / Brand Name <span class="tooltip1" title="headline for the widget."><i class="fa fa-info-circle"></i></span></p>
									<input class="form-control" name="topbar_text" id="topbar_text" required="required" placeholder="Write Brand Name"/>					
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									...
									<img width="80px" class="play_icon" src="<?php echo e(url('/')); ?>/images/convertsound-fav.png">
									<input value="<?php echo e(url('/')); ?>/images/convertsound-fav.png" type="hidden" name="brandlogo" id="brandlogo">
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-md-5">
								<p class="setting-title">Reminder Widget<span class="tooltip1" title="headline for the widget."><i class="fa fa-info-circle"></i></span></p>
									<select class="form-control selectpicker" name="position_widget" id="position_widget">
										<option value="bar">Sidebar</option>
										<option value="side">Strip</option>
										<option value="corners">Corners</option>
									</select>
								</div>
								<div class="col-md-7">
								<p class="setting-title">Position<span class="tooltip1" title="Description for the widget."><i class="fa fa-info-circle"></i></span></p>
									<select class="form-control selectpicker" name="position_widget" id="position_widget">
										<option value="onload">Left</option>
										<option value="trigger_time">Right</option>
										<option value="scroll_height">Top</option>
										<option value="scroll_height">Bottom</option>
									</select>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<p class="setting-title">Font Family<span class="tooltip1" title="Select Font Family."><i class="fa fa-info-circle"></i></span></p>
								<select id='fontkits' class="form-control selectpicker"><option></option></select>
							</div>
							<div class="form-group">
							<!-- 	<div class="col-md-7">
					...
					<div class="row" id="campaign_type_section" style="display:block;">
						...
						<p class="opt-title">Optin Message Sound Settings <span class="tooltip1" title="Sound Setting."><i class="fa fa-info-circle"></i></span></p>
							...
							<div class="col-md-4 col-xs-12 col-sm-4" style="cursor:pointer">
								<div class="campaign-option-box" id="cu" data-type="Custom Upload">
									<div class="info_button"><span class="tooltip1" title="This is my image's tooltip message!"><i class="fa fa-info-circle"></i></span></div>
									<div class="bar-widget">
										<div class="table-box">
											<div class="table-detail text-center">
						...
						<p class="opt-title">Optin Settings <span class="tooltip1" title="Here are some basic settings for the widget, Please fill below fields for Widget."><i class="fa fa-info-circle"></i></span></p>
							...
							<div class="form-group">
								...
								<p class="setting-title">Optin Message in Skip Condition<span class="tooltip1" title="headline for the optin."><i class="fa fa-info-circle"></i></span></p>
									<input class="form-control" name="sp_optin_message" id="sp_optin_message" required="required" placeholder="Write Optin Message for Skip Condition Here"/>					
								</div>
							</div>
							...
							<div class="form-group">
								...
								<p class="setting-title">Thank You Message <span class="tooltip1" title="Description for the widget."><i class="fa fa-info-circle"></i></span></p>
									<input class="form-control" name="thankyou_message" id="thankyou_message"  required="required"  placeholder="Write Thank You Message on successful submission."/>					
								</div>
							</div>
<!-- 							<div class="form-group center pt5 mb10">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<label class="switch pull-right">
								  <input type="checkbox" name="phone_no_optin" id="phone_no_optin">
...
$('#save_campaign').click(function(){
	...
	if(ajaxchk==true){
		...
		$.ajax({
			type: "GET",
			url: "<?php echo e(url('/campaign/ajaxsave')); ?>",
...
jQuery.each(fontkits, function (index, value) {
	jQuery('#fontkits').append($('<option/>', { 
        'value': value,
        'text' : index 
    }));
	// $('#t2s_language')[0].options.add( new Option(index,value) );
...
jQuery('#form-edit-post').submit(function(event){
	...
	$.ajax({
	    ...
	    success:function(response) {
	        $('#'+upfor).val("<?php echo e(url('/')); ?>"+'/'+response);
        	$('#'+upfor+'_font').hide();
	        $('#'+upfor+'_preview').attr('src', ("<?php echo e(url('/')); ?>"+'/'+response));
        	$('#'+upfor+'_preview').show();
