                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6" style="cursor:pointer">
                            <div class="white-box">
                                <div class="bar-widget">
                                    ...
                                    <div class="table-box">
                                        <div class="table-detail text-center">
                                            <div class="big-icons"><img src="{{url('images/activecampaign_logo.png')}}"></div>
                                            <!-- <div class="action-buttons"> -->
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6" style="cursor:pointer">
                            <div class="white-box">
                                <div class="bar-widget">
                                    ...
                                    <div class="table-box">
                                        <div class="table-detail text-center">
                                            <div class="big-icons"><img src="{{url('images/getresponse_logo.png')}}"></div>
                                            <!-- <div class="action-buttons"> -->
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6" style="cursor:pointer">
                            <div class="white-box">
                                <div class="bar-widget">
                                    ...
                                    <div class="table-box">
                                        <div class="table-detail text-center">
                                            <div class="big-icons"><img src="{{url('images/sg-autorepondeur_logo.png')}}"></div>
                                            <!-- <div class="action-buttons"> -->
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6" style="cursor:pointer">
                            <div class="white-box">
                                <div class="bar-widget">
                                    ...
                                    <div class="table-box">
                                        <div class="table-detail text-center">
                                            <div class="big-icons"><img src="{{url('images/mailchimp_logo.png')}}"></div>
                                            <!-- <div class="action-buttons"> -->
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6" style="cursor:pointer">
                            <div class="white-box">
                                <div class="bar-widget">
                                    ...
                                    <div class="table-box">
                                        <div class="table-detail text-center">
                                            <div class="big-icons"><img src="{{url('images/webinarjam_logo.png')}}"></div>
                                            <!-- <div class="action-buttons"> -->
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6" style="cursor:pointer">
                            <div class="white-box">
                                <div class="bar-widget">
                                    ...
                                    <div class="table-box">
                                        <div class="table-detail text-center">
                                            <div class="big-icons"><img src  ="{{url('images/everwebinar_logo.png')}}"></div>
                                            <!-- <div class="action-buttons"> -->
                    ...
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <div class="row">
                            <div class="form-group opt" id="acampapiurl">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" name="acampapiurl" required="required" value="{{$acampurl}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group opt" id="acampapikey">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" name="acampapikey" required="required" value="{{$acampkey}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group opt" id="acamp_list_container">
                                ...
                                <div class="col-md-8">
                                   <select class="form-control selectpicker" name="acamp_account_list" id="acamp_account_list" required="required">
                                        <option value="{{$acamplistid}}">{{$acamplistname}}</option>
                                    </select>
                                </div>
                            </div>
   ...
   var acampchk=true;
    $('#acamp_account_details').submit(function(e){
        ...
        if(acampchk==true){
            ...
            acampchk=false;
            $.ajax({
                url: "{{url('/integration/saveactivecamp')}}",
                processData: false,
                data:formdata,
                type: "GET",
                success: function(data){
    ...
    $('#acamp_lists').submit(function(e){
        ...
        if(acampchk==true){
            ...
            acampchk=false;
            $.ajax({
                url: "{{url('/integration/saveactivecamplist')}}",
                processData: false,
...
$('#aweber_account_id').change(function(){
    if($(this).val()!='')
    {
        ...
        $('#awb_list_container').show();
        $.ajax({
            url: "{{url('/integration/gtwgetlist')}}",
            type: "GET",
            processData: false,
            data:'account_id='+account_id,
            success: function(data){
                    ...
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <div class="row">
                            <div class="form-group opt" id="getresponsekey">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" name="getresponsekey" required="required" value="{{$getresponsekey}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group opt" id="getresponse_list_container">
                                ...
                                <div class="col-md-8">
                                   <select class="form-control selectpicker" name="getresponse_campaign_list" id="getresponse_campaign_list" required="required">
                                        <option value="{{$getresponseCampid}}">{{$getresponseCampname}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
   ...
   var grchk=true;
    $('#getresponse_account_details').submit(function(e){
        ...
        if(grchk==true){
            ...
            grchk=false;
            $.ajax({
                url: "{{url('/integration/savegetresponse')}}",
                processData: false,
                data:formdata,
                type: "GET",
                success: function(data){
    ...
    $('#getresponse_campaign_lists').submit(function(e){
        ...
        if(grchk==true){
            ...
            grchk=false;
            $.ajax({
                url: "{{url('/integration/savegetresponselist')}}",
                processData: false,
                data:'listid='+listid+'&listname='+listname,
                type: "GET",
                success: function(data){
                    ...
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <div class="row">
                            <div class="form-group opt" id="sgautomemberid">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" required="required" name="sgautomemberid" value="{{$sgautomemberid}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group opt" id="sgautoapikey">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" required="required" name="sgautoapikey" value="{{$sgautokey}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group opt" id="sgauto_list_container">
                                ...
                                <div class="col-md-8">
                                   <select class="form-control selectpicker" name="sgauto_account_list" id="sgauto_account_list" required="required">
                                        <option value="{{$sgautolistid}}">{{$sgautolistname}}</option>
                                    </select>
                                </div>
                            </div>
   ...
   var sgautochk=true;
    $('#sgauto_account_details').submit(function(e){
        ...
        if(sgautochk==true){
            ...
            sgautochk=false;
            $.ajax({
                url: "{{url('/integration/savesgauto')}}",
                processData: false,
                data:formdata,
                type: "GET",
                success: function(data){
    ...
    $('#sgauto_lists').submit(function(e){
        ...
        if(sgautochk==true){
            ...
            sgautochk=false;
            $.ajax({
                url: "{{url('/integration/savesgautolist')}}",
                processData: false,
                data:'listid='+listid+'&listname='+listname,
                type: "GET",
                success: function(data){
...
$('.disconnect').click(function(){
    ...
    $('.loader-bg').show(100);
    $.ajax({
        url: "{{url('/integration/disconnectApp')}}",
        type: "GET",
        processData: false,
        data:'app='+app,
        success: function(data){
