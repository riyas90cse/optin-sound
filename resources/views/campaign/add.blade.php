	...
	<div id="page-wrapper">       
		<div class="row">
			<div class="col-md-12">
				...
				<form method="post" action="{{ url('campaign/save') }}" id="valWizard" class="panel-wizard">
					{{ csrf_field() }}
...
<!-- 
				...
				<textarea value="{{ $value->id }}">{{ $value->niche_category }}</textarea>
							...
							<div class="col-md-12">
								<div class="col-md-8">
									...
									<div class="form-group opt" data-show="opt1">
										...
										<div class="col-md-7">
											<img src="{{ url('/images/convertsound-fav.png')}}" id="playservice" alt="play/pause" title="To Play Click Here">
											<audio class="form-control" name="soundpreview" id="soundpreview" controls>
											  <source src="{{ url('/uploads/sound/demo-jogi-sound.mp3')}}" type="audio/mpeg">
											  Your browser does not support the audio tag.
											</audio> 
										</div>
									</div>
...
<!-- 									<div class="form-group">
									...
									<div class="form-group country_re" >
										...
										<div class="col-md-7">
											...
											<a href="javascript:void(0);" class="remove_button" title="Remove field"><img src="{{url("images/remove-icon.png")}}"></a>
										</div>
									</div>
									<div class="form-group country_re">
										<div class="col-md-5">
										...
										<div class="col-md-7">
											<input type="text" name="redirectionlink" class="form-control" id="redirectionlink"/><a onclick="add_bookingrate();" class="add_button" href="javascript:void(0);" title="Add field"><img src="{{url('images/add-icon.png')}}"></a>
										</div>
									</div>
