		...
		<div class="campsection step2" id="step2">
			<div class="content">
				...
				<div class="row" id="action_section">
					...
					<form method="get" id="widget_action" action="{{ url('campaign/savewidget') }}">
...
<!-- 				<div class="form-group">
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input type="number" min-value="0" value="{{$campaign[0]->repeat_trigger_time}}" name="repeat_trigger_time" id="repeat_trigger_time" class="form-control">
							</div>
						</div>
...
<!-- 											<option  value="Matthew">Matthew, Male</option>
								...
								<div class="form-group opt" id="t2s_output" style="display: none;">
									...
									<div class="col-md-7">
										...
										<input type="hidden" name="sound_src" value="{{$campaign[0]->sound_src}}" id="sound_src">
