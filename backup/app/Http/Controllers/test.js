...
'geolocation':{}
'widget':{
'ht':'Big offer for early birds',
'hc':'#ff0000',
'hb':'#ffffff',
'dt':'Tap below to reveal the offer for you!!!',
'dc':'#2239c8',
'db':'#dccece',
'position':'bottom-right',
'icon':'http://app.convertsound.com/images/convertsound-fav-def.gif'
}
...
document.getElementById('soundcontainer').innerHTML="<div id='pp-main'><h2 id='pp_ht'>"+cs.widget.ht+"</h2><p id='pp_dt'>"+cs.widget.dt+"</p><div id='pp_icon_blk'><img id='pp_icon' src='"+cs.widget.icon+"'></div></div>";
