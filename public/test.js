...
'exit_intent_pop':'on',
'phone_no_optin':'on',
'widget':{'tbt':'Nishant Sharma', 'tbc':'#ff0000', 'tbb':'#ffffff','brandicon':'http://app.optinsound.com/images/convertsound-fav.png','ht':'Big offer for early birds', 'hc':'#ff0000', 'hb':'#ffffff', 'dt':'Tap below to reveal the offer for you!!!', 'dc':'#2239c8', 'db':'#dccece', 'position':'bottom-right', 'icon':'http://app.optinsound.com/images/convertsound-fav-def.gif'},
...
function chkdomainexcludepages (links){

for (var key in links.messages) {
...
var opswidgetHtml="<header class='ops-header'>\
    ...
    <div class='ops-closebtn' id='ops-closebtn'><img title='Close button' alt='Close Button' src='./switch.png'/></div>\
  </header>\
  <div class='ops-content'>\
    ...
    <div class='ops-formsection' id='ops-formsection'>\
      ...
      <form action='#' id='optinform' method='post'>\
        ...
        <input name='phone' class='ops-phone' placeholder='Phone Number (Optional)' type='text'>\
    ...
    <div class='ops-action'>\
      <div class='ops-full'>\
        ...
        <a class='ops-skip' id='ops-skip'>Skip</a>\
      </div>\
    </div>\
  </div>";
...
document.getElementById('ops-playbutton').addEventListener('click',function(){
  ...
  // document.querySelector('#ops-skip').style.display='none';
