...
'delay_time':'',
'st':'100',
'audiosrc':'https://convertsound.s3.us-west-2.amazonaws.com/1526482829-cvs.mp3',
...
document.getElementById('soundcontainer').innerHTML='<audio class="form-control" name="dfy_soundpreview" id="convertsound_audio" muted autoplay controls><source src="https://convertsound.s3.us-west-2.amazonaws.com/1526491745-cvs.mp3" type="audio/mpeg">Your browser does not support the audio tag.</audio><button id="unmuteButton" style="margin-top:20px;">Play</button>';
var tt=true;
