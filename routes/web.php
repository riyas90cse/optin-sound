...
Route::group(['middleware' => 'auth'], function () {
	...
	//Overlay Campaign
	Route::get('/oc/','OverlayController@index');
	Route::get('/oc/create','OverlayController@create');
	Route::get('/overlay/ajaxsave','OverlayController@ajaxsave');
	Route::get('/overlay/ajaxupdate','OverlayController@ajaxupdate');
	Route::get('/oc/edit/{id}','OverlayController@edit');
	Route::get('/oc/update/{id}','OverlayController@update');
	Route::get('/oc/delete/{id}','OverlayController@delete');
...
//	Route::post('/donesound','DoneSoundController@showUploadFile');
	...
	Route::get('/integration/disconnectApp','IntegrationController@disconnect_app');
	// Aweber
	...
	// ActiveCampaign
	Route::get('/integration/saveactivecamp','IntegrationController@saveactivecamp_ajax');
	Route::get('/integration/saveactivecamplist','IntegrationController@saveactivecamplist_ajax');
	// gotowebinar
	Route::get('/gotowebinarauth','IntegrationController@gotowebinar');
	Route::get('/integration/gtwgetlist','IntegrationController@gotowebinarlist_ajax');
	// getResponse
	Route::get('/integration/savegetresponse','IntegrationController@savegetresponse_ajax');
	Route::get('/integration/savegetresponselist','IntegrationController@savegetresponselist_ajax');
	// SgAutoresponder
	Route::get('/integration/savesgauto','IntegrationController@savesgauto_ajax');
	Route::get('/integration/savesgautolist','IntegrationController@savesgautolist_ajax');
...
Route::get('/optin','ReportController@save')->middleware('cors');

//overlay handle
Route::get('/overlay/{handle}','OverlayController@handle');


// Route::group(['prefix' => 'overlay', 'middleware' => 'redirectcrawlers'], function() {
// 	Route::get('/{handle}','OverlayController@handle');
// });